    ...
    const mapReviews = (reviews) => {
        ...
        const reviewArray = reviews.map(review => 
            <div className="review-card">
                <h4>Review: { review.author_name }</h4>
        ...
        return (
            <>
                <div className="edit-and-delete-buttons">
                    <Button className="review-buttons" onClick={ () => props.editReviewDisplay() }>Edit</Button>
                    <Button className="review-buttons" onClick={ () => props.deleteReview(review_id) }>Delete</Button>
                </div>
            </>
        );
    };
                            ...
                            <Col className="col-12">
                                <div className="restaurant-profile-reviews-section">
                                    <div className="restaurant-profile-reviews-div">
                                        <h2>Reviews: {props.restaurant.reviews.length }</h2>
